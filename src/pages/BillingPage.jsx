...
import { getInvoices, createInvoice, getClients } from '../api';
            ...
            <form onSubmit={handleSaveInvoice}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 }}>
                <div>
                  ...
                  <input type="text" value={newInvoice.no} onChange={e => setNewInvoice({ ...newInvoice, no: e.target.value })} required placeholder="e.g. INV/2425/0094"
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 }}>
                ...
                <div>
                  ...
                  <input type="date" value={newInvoice.due} onChange={e => setNewInvoice({ ...newInvoice, due: e.target.value })} required
                    style={{ width: "100%", padding: "8px 12px", border: "1px solid #E2E8F0", borderRadius: 6 }} />
                </div>
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 }}>
                <div>
                  ...
                  <input type="number" value={newInvoice.amount} onChange={e => setNewInvoice({ ...newInvoice, amount: parseFloat(e.target.value) || 0 })} required min="0"
                    style={{ width: "100%", padding: "8px 12px", border: "1px solid #E2E8F0", borderRadius: 6 }} />
                </div>
                <div>
                  <label style={{ display: "block", fontSize: 12, color: "#64748B", marginBottom: 4 }}>Paid Amount (₹)</label>
                  <input type="number" value={newInvoice.paid} onChange={e => setNewInvoice({ ...newInvoice, paid: parseFloat(e.target.value) || 0 })} required min="0"
                    style={{ width: "100%", padding: "8px 12px", border: "1px solid #E2E8F0", borderRadius: 6 }} />
                </div>
              </div>
              ...
              <div style={{ display: "flex", gap: 12, justifyContent: "flex-end" }}>
                ...
                <button type="submit" style={{ padding: "8px 20px", border: "none", borderRadius: 6, background: "#6366F1", color: "#fff", cursor: "pointer", fontWeight: 600 }}>Save Invoice</button>
              </div>
            </form>
          </div>
        </div>
